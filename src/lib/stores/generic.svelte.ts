import type { Player, Manager, Fixture, MatchBundle } from "$lib/types/types"
...
export const clientMatchCache = $state<Record<string, MatchBundle>>({});
...
export let finishingWeightMap = $state({})
